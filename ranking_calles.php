...
<?php include_once './vistas/navbar.php' ?>
      <section class="container pt-4 buscador-personas">
        <h1 class="h1-encabezado pt-4 pb-4">Ranking calles</h1>
      </section>
...
<?php 
        ...
        <div class='text-center pt-4'>
                        ...
                        <div>
                                ...
                                <input type='number' class='ranking-b__number' step='100' id='input_max_number' min='0' value='0' oninput='validity.valid||(value='')';>
                        </div>
